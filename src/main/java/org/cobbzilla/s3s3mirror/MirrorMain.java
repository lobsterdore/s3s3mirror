...
public class MirrorMain {
    ...
    protected void parseArguments() throws Exception {
        ...
        if (!options.hasAwsKeys()) {
            ...
            if (options.isUseIamRole() == false && !options.hasAwsKeys()) {
                throw new IllegalStateException("IAM Role usage not specified and ENV vars not defined: " + MirrorOptions.AWS_ACCESS_KEY + " and/or " + MirrorOptions.AWS_SECRET_KEY);
            }
        }
